...
const ProductCard = ({product}) => {
    ...
    return product && (
        <div onClick={()=>navigate(`/AllProducts/${product.category.toLowerCase()}/${product._id}`)} className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full">
