...
const Cart = () => {
    ...
    const {products,currency,cartItems,removeFromCart,getCartCount,updateCartItems,getCartAmount,navigate} = useAppContext();
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button onClick={()=> {navigate('/AllProducts') ; scrollTo(0,0)}} className="group cursor-pointer flex items-center mt-8 gap-2 text-indigo-500 font-medium">
